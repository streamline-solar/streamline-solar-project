        ...
        <div className="left-text-wrapper">
          <div className="left-text-content">
            ...
            <div className="left-text-body">
              <p className="SmallText">{props.body}</p>
            </div>
          </div>
        </div>
        <div className="image-wrapper">
          <div className="image-image">
            <img className="project-body-image" src={props.img} alt={props.alternative} />
          </div>
        </div>
      </div>
    </div>
            ...
            <section className="streamline-main-page">
              <div className="index-page-wrapper">
                <div className="inner-index-wrapper">
                  ...
                  <MainBody
                    title='Our Students'
                    body='Not only does the Streamline Solar Stops project connect students to the community, but it connects us to each other. We are striving to encourage extensive interdisciplinary cooperation between all corners of the university. Our project is entirely student run; from communication and outreach, to energy technology and design, our students have the skills and drive to do it all. Our team is made up of students from departments all across campus including Engineering, Arts and Architecture, and Business.'
                    img={OurStudents}
                    alternative='students pic'
                  />
